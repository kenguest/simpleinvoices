...
class SIXModule extends Six {
	...
	protected function toPDF(){
		require_once(SIX_ROOT . '/plugins/tcpdf/tcpdf.php');
		$this->PDF = new TCPDF($this->pdfOrientation, $this->pdfUnit, $this->pdfFormat);
		$this->PDF->setHeaderData("logo2.jpg", "45", "Genlu LLC", "Invoice para testear a ver que onda.");
		...
		$this->PDF->addPage();
		$this->PDF->writeHTML("<h2>holaaaaa!</h2>", true, 0);
		$x = $this->PDF->getX();
		$y = $this->PDF->getY();
		$str = "<ul><li>hola</li><li>hola2</li></ul>";
		$this->PDF->writeHTMLCell('50', '20', $x, $y, $str, 1, 1, 1);
		$str = "<table border='1'><tr><td bgcolor='red'>hola1</td><td>hola2</td></tr><tr><td>hola1</td><td>hola2</td></tr><tr><td>hola1</td><td>hola2</td></tr></table>";
		$this->PDF->writeHTML($str, true, 1);
		$this->PDF->Output();
	}
