...
<b>Preferences</b>
	<hr></hr>
        ...
        <table align=center>
                ...
                <tr>
                        <td class='details_screen'>Currency sign <a href="docs.php?t=help&p=inv_pref_currency_sign" rel="gb_page_center[450, 450]"><img src="./images/common/help-small.png"></img></a></td><td><input type=text name='pref_currency_sign' value="{$preference.pref_currency_sign}" size=50></td>
                </tr>
                <tr>
				{$gates = addslashes($preference.pref_inv_heading)}
