<form name="frmpost" action="index.php?module=purchases&view=save&action=update" method="POST">

<input type="hidden" id="module" value="purchases" />
<input type="hidden" id="mode" value="edit" />
<input type="hidden" id="invoice_id" name="invoice_id" value="{$data.invoice.id}" />

<table class="header">
	<tr>
		<td class="module" style="background-color:#9D0000;color:white">Module :: Purchases</td>
...
{* $default_invoice_number *}
	...
	<table class="invoice_header_right">
		<tr>
			<td class="my_details_screen">Internal Invoice #</td>
			<td>
		...
		<tr>
			...
			<td>
				<input type="text" id="vendor_invoice_number" name="vendor_invoice_number" size="13" value="{$data.vendor_number}" />
			</td>
		</tr>
		<tr>
