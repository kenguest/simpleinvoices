<form name="invoiceForm" action="index.php?module=purchases&view=save" method="POST">

<input type="hidden" id="module" name="module" value="purchases" />
<table class="header">
	<tr>
...
<div class="invoice_standard">
	<table class="invoice_header_left">
		<tr>
			<td class="my_details_screen">Customer Name</td>
			<td>Genlu LLC</td>
		</tr>
		<tr>
