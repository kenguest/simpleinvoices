...
<div style="text-align:center;">
	...
	<a href="index.php?module=sales&view=create">{$LANG.add_new_invoice}</a> ::
</div>
<hr />
...
{get_url_for_pdf item=$invoice current_pdf=$url_for_pdf output=url_pdf}
	...
	<a class="index_table"
	 ...
	 href="index.php?module=sales&view=quick_view&submit={$invoice.id}">
	...
	<a class="index_table" title="{$LANG.edit_view_tooltip}"
	 href="index.php?module=sales&view=edit&submit={$invoice.id}">
	...
	<a title="{$LANG.export_tooltip} {$LANG.export_xls_tooltip} {$LANG.format_tooltip}"
	 class="index_table" href="index.php?module=sales&view=export&submit={$invoice.id}&format={$options.spreadsheet}">
	 <img src="images/common/xls.gif" height="16" border="0" padding="-4px" valign="bottom" /><!-- $spreadsheet --></a>

	<!-- NEW PDF Engine -->
	<a title="New PDF Engine"
	 class="index_table" href="{$PDFnew}">
	 <img src="images/common/pdf.jpg" height="16" border="0" padding="-4px" valign="bottom" /><!-- $pdf --></a>
  ...
  <!-- Payment --><a title="{$LANG.process_payment}"
   class="index_table" href="index.php?module=payments&view=process&submit={$invoice.id}&op=pay_selected_invoice">$</a>
	<!-- Email -->
	<a href="index.php?module=sales&view=email&stage=1&submit={$invoice.id}" title="{$LANG.email}"><img src="images/common/mail-message-new.png" height="16" border="0" padding="-4px" valign="bottom" /></a>
