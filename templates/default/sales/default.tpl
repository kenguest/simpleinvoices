...
<thead>
	<tr class="sortHeader">
		...
		<th class="noFilter sortable">Invoice Number</th>
...
{foreach from=$invoices item=invoice}
	...
	<a class="index_table" title="{$LANG.edit_view_tooltip} {$invoice.preference.pref_inv_wording} {$invoice.invoice.id}"
	 href="index.php?module=invoices&view=details&submit={$invoice.invoice.id}&action=edit&invoice_style={$invoice.invoiceType.inv_ty_description}">
