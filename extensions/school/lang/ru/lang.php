...
$LANG['cert_this_is_to_certify'] = "This is to certify that";
...
$LANG['from'] = "от";
$LANG['level'] = "level";
$LANG['number_of_payment_periods'] = "Платежный период №";//google translate //CHANGE TO: payment_period_number
$LANG['place_of_issue'] = "Place of Issue";
$LANG['Print'] = "Print";
$LANG['payments_start'] = "Платежи начало"; //google translate
$LANG['payments_end'] = "Платежи конец"; //google translate
...
$LANG['teaching_hours'] = "Учебные часы";//google translate
$LANG['to'] = "to";
$LANG['total_services_rendered'] = "Total services rendered, to the amount of";
$LANG['services_implemented_in_full'] = "Вышеперечисленные услуги выполнены полностью и в срок. Заказчик претензий по объему, качеству и срокам оказания услуг не имеет";
