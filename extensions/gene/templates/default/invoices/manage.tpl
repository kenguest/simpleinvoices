...
{foreach from=$invoices item=invoice}
	...
	<td class="index_table">{$invoice.gene_total}</td>
	<!--
	<td class="index_table">{$invoice.paid|number_format:2}</td>
	-->
	<td class="index_table">{$invoice.gene_owing}</td>
	<td class="index_table">{if $invoice.gene_owing > 0}{$invoice.overdue}{/if}</td>
