...
$LANG['module_purchases_wording'] = "Purchase Invoice";
$LANG['module_sales_wording'] = "Invoice";
$LANG['module_reports_price_list_wording'] = "Price List";

$LANG['module_sales']['company'] = "Customer";
$LANG['module_sales']['company_account'] = "Customer Account";
$LANG['module_sales']['company_add'] = "Add New Customer";
$LANG['module_sales']['company_contact'] = "Customer contact (Attn)";
$LANG['module_sales']['company_details'] = "Customer details";
$LANG['module_sales']['company_edit'] = "Edit Customer";
$LANG['module_sales']['company_id'] = "Customer ID";
$LANG['module_sales']['company_name'] = "Customer name";
$LANG['module_sales']['companys'] = "Customers";

$LANG['module_purchases']['company'] = "Vendor";
$LANG['module_purchases']['company_account'] = "Vendor Account";
$LANG['module_purchases']['company_add'] = "Add New Vendor";
$LANG['module_purchases']['company_contact'] = "Vendor contact (Attn)";
$LANG['module_purchases']['company_details'] = "Vendor details";
$LANG['module_purchases']['company_edit'] = "Edit Vendor";
$LANG['module_purchases']['company_id'] = "Vendor ID";
$LANG['module_purchases']['company_name'] = "Vendor name";
$LANG['module_purchases']['companys'] = "Vendors";
